                                            ...
                                            research.map((research) => (
                                                <tr class="bg-white border-b">
                                                    ...
                                                    <div className="flex flex-row justify-center">
                                                        <p onClick={() => viewResearch(research.opportunityId)} className="transition-all mx-2 font-medium text-yellow-400 hover:underline hover:cursor-pointer">View</p>
                                                        {isStaff &&
                                                            <p onClick={() => editResearch(research.opportunityId)} className="transition-all mx-2 font-medium text-blue-600 dark:text-blue-500 hover:underline hover:cursor-pointer">Edit</p>}
                                                        {isStaff &&
                                                            <p onClick={() => deleteResearch(research.opportunityId)} className="transition-all mx-2 font-medium text-red-600 dark:text-red-600 hover:underline hover:cursor-pointer">Delete</p>}
                                                   </div>
                                                    </td>
                                                </tr>
                                            ))

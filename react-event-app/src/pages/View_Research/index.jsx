                ...
                <div class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-gray-50">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="flex flex-row">
                            ...
                            <p className="px-3 rounded-md shadow-md">{research.type}</p>
                        </div>
                        <div className="flex flex-row">
                        ...
                        <div className="flex flex-row justify-center h-10 my-2">
                                <button type="button" onClick={handleClick} className="hover:bg-yellow-400 hover:text-white border-yellow-400 text-yellow-400 transition-all rounded-md justify-center w-3/5 border shadow-md font-poppins font-semibold mx-2">APPLY</button>
                            </div>
                            <div className="flex flex-row justify-center h-10 my-2">

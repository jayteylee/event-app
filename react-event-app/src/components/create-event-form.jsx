                ...
                <div className="">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <div className="flex flex-row justify-center">
                            <button type="submit" className="transition-all mx-5 px-4 rounded-md border shadow-md border-blue-500 text-blue-500 hover:text-white hover:bg-blue-500">Create Event</button>
